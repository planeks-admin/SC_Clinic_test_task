...
export class TasksService {
     ...
     * @throws ApiError
     */
    public static claimTask(data: TasksClaimTaskData): CancelablePromise<TasksClaimTaskResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/tasks/claim-task/{id}',
            path: {
                id: data.id
            },
            errors: {
